...
import { User, Mail, Phone, MapPin, Lock, Bell, Shield, Camera, Save, CheckCircle, ArrowLeft, Scale, FileText } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-bold text-white mb-4">Lawyer Account Settings</h1>
            <p className="text-xl text-gray-300">Manage your professional profile and credentials</p>
          </div>
        </div>
              ...
              <div className="text-center mb-6">
                <div className="relative inline-block">
                  {imagePreview ? (
                    ...
                    <div className="w-32 h-32 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white text-4xl font-bold mb-4">
                      {getInitials()}
                    </div>
                  )}
                  
                  <label className="absolute bottom-4 right-0 bg-purple-500 rounded-full p-3 hover:bg-purple-600 transition-all cursor-pointer">
                ...
                <h3 className="text-white font-bold text-xl mb-1">{formData.name || 'Lawyer'}</h3>
                <div className="flex items-center justify-center gap-2 text-gray-400">
                  <Scale className="w-4 h-4" />
                  <p className="capitalize">Legal Professional</p>
                </div>
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="4"
                      className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
                      placeholder="Enter your Bar Council ID, specializations, experience, certifications, etc."
                    />
                  </div>
                </div>
              )}
              ...
              <div className="flex items-center justify-end space-x-4 mt-8 pt-8 border-t border-white/10">
                ...
                <button
                  onClick={handleSave}
                  disabled={isSaving}
                  className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-3 rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 flex items-center space-x-2"
                >
                  {isSaving ? (
                    <>
